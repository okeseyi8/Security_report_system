...
const Report = () => {
  ...
  console.log("Semdig state:", isSending);
      ...
      <div className="flex justify-between items-center">
        <div>
          {user.userType === "Civilian" ? (
            <div className="text-[#5d7186] text-[21px]">Hi, {user.name}</div>
          ) : (
            <h1 className="text-[#5d7186] text-[21px]">
        ...
        <div>
          <ul className="flex text-[#8a949e] items-center text-[23px] gap-6">
            <li>{/* <IoNotifications className="" /> */}</li>
            <li>
              <FaClock />
            </li>
          </ul>
      ...
      <div className="p-3 px-7 rounded-lg shadow-lg mt-7 bg-white">
        ...
        <form className="flex flex-col gap-4 text-[16px] text-[#5d7186]">
          ...
          <div className=" flex justify-between  items-center gap-5 px-5 -mb-4 py-4  bg-[#F9F7F7] rounded-t-lg">
            {user.userType === "Civilian" ? (
              <h2 className="font-bold text-[#313b5e] ">
                Top Security Personnels in your area
              </h2>
            ) : (
